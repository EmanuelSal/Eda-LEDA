...
public class StudentSortingTest {
	...
	public void setUp() {
		...
		popularVetorTeste(new Integer[] {1, 2, 4, 5, 7, 7, 7});
	...
	public void popularVetorTeste(Integer[] arrayPadrao) {
		this.vetorTeste = Arrays.copyOf(arrayPadrao, arrayPadrao.length);
	}
